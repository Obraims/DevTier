...
export const K = {
  ...
  legacy: { a: 1.0, b: 0.8, c: 0.2, d: 0.2, e: 0.2, g: 0.4, f: 5.5, activeCap: 15, bonusMax: 11 },
  ovrCap: 88,
...
// The people who built devtier. Keyed by LOWERCASE GitHub login; matched
