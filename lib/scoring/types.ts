...
// A devtier founder's bespoke card treatment. Declared once (lib/scoring/constants
...
export interface FounderMeta {
  ...
  tagline: string; // tooltip + flavor, e.g. "Co-founder of devtier"
}
...
export interface Card {
  ...
  // Set only for devtier founders — their bespoke card art/accent + hint metadata.
