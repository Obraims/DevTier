...
// city in their GitHub "location".
const PINNED: Record<string, string> = {
  colemurray: "us",
  neptunehub: "it", // NeptuneHub — Italy (derived from timezone example)
  hrydgard: "se", // Henrik Rydgård — Sweden
  mvanhorn: "us", // Matt Van Horn — USA
  binaricat: "cn", // binaricat — China
};
