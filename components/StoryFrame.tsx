...
import { resolveCardTheme, resolveResultTheme, type CardSkin } from "./finishTheme";
...
const StoryFrame = forwardRef<HTMLDivElement, { card: Card; skin?: CardSkin }>(function StoryFrame(
  { card, skin = "classic" },
  ref,
) {
  ...
  return (
    ...
    >
      ...
      <div style={abs(SAFE_TOP + 8)}>
        ...
        >
          DEV<span style={{ color: BRAND }}>TIER</span>
        </div>
        <div
          style={{
            marginTop: 20,
      ...
      {/* bottom — the CTA: the loudest text in the lower frame (brand green +
          ...
          tap target. Bookends the green "DEVTIER" up top. */}
      <div
        style={{
          position: "absolute",
          left: 0,
