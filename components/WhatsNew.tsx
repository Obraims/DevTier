...
const SEEN_KEY = "devtier:team-news:seen";
...
function TeamNews() {
  ...
  const dismiss = useCallback(() => {
    ...
    // Defer the synchronous storage write so it doesn't block the next frame paint
    setTimeout(() => {
      try {
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-[70] flex items-center justify-center bg-bg-deep/85 p-[22px] max-[560px]:items-end max-[560px]:p-0"
