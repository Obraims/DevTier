# Contributing to DevTier

Thanks for wanting to help scout GitHub's finest ⚽ — bug fixes, new playstyles, sharper scoring, and docs are all welcome.

## Getting started

DevTier is a [Next.js](https://nextjs.org) (App Router) app in TypeScript, styled with Tailwind. You'll need **Node 20+** and **npm**.

```bash
git clone https://github.com/Obraims/DevTier.git
cd devtier
npm install
...
Open an [issue](https://github.com/Obraims/DevTier/issues) (there are templates). Good places to start: new playstyles/archetypes, scoring tweaks, language-logo coverage, accessibility, and card/OG rendering.
