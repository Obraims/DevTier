...
Report it privately through GitHub's **[private vulnerability reporting](https://github.com/Obraims/DevTier/security/advisories/new)** (repo → **Security** → **Report a vulnerability**). If that isn't available, email **stephenbaraka9283@gmail.com**.
...
- the **devtier.com** web app and its API routes,
...
- vulnerabilities in third-party dependencies with no working exploit against DevTier (please report those upstream),
- automated scanner output with no demonstrated impact.

## Supported versions

DevTier is a continuously-deployed web app — only the currently deployed version (tracking `master`) is supported. There are no tagged releases to backport fixes to.
