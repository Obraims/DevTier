...
export const alt =
  "DevTier Scout Duel — two player cards facing off across a lightning strike";
...
export default async function Image({
  ...
  after(() => Promise.all([recordScout(username), recordScout(opponent)])); // count unfurls like the card OG does
