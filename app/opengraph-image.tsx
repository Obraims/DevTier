...
// Branded preview for the home page / bare devtier.com links. Next wires this as
// the default og:image + twitter:image automatically (metadataBase is absolute).
export const runtime = "nodejs";
export const alt = "DevTier — your GitHub, rated out of 99";
    ...
    (
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", flex: 1, height: "100%", paddingRight: 48 }}>
          ...
          <div style={{ display: "flex", fontSize: 28, color: "#6e7681" }}>dev-tier.vercel.app</div>
        </div>
