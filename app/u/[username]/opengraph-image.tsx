...
export const alt = "DevTier player card";
    ...
    return new ImageResponse(
      (
        ...
        >
          ...
          <div style={{ display: "flex", fontSize: 30, color: "#39d353", fontWeight: 700, marginTop: 26 }}>dev-tier.vercel.app</div>
        </div>
      ),
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", flex: 1 }}>
          ...
          <div style={{ display: "flex", fontSize: 26, color: "#6e7681", marginTop: 32 }}>dev-tier.vercel.app/{card.login}</div>
        </div>
      </div>
    ),
